  ...
  return (
    <header className="bg-white sticky top-0 z-10" style={{ borderBottom: '1px solid #D4B896' }}>
      <div className="max-w-2xl mx-auto px-4 py-3 relative flex items-center justify-between">
        ...
        {!backTo && (
          <div>
            <div className="font-logo text-4xl leading-none inline-block" style={{ color: '#2C2422', fontWeight: 500, letterSpacing: '0.01em', transform: 'scaleX(1.2) scaleY(1.2)', transformOrigin: 'left center' }}>Shulalá</div>
